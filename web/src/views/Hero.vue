<template>
  <div class="page-hero" v-if="model">
    <div class="topbar bg-black py-2 px-3 d-flex ai-center text-white">
      ...
      <div class="px-3 flex-1 pt-2">
        <span class="text-white">王者荣耀</span>
        <span class="ml-2">攻略站</span>
      </div>
      <router-link to="/" tag="div" class="pt-2">更多英雄 &gt;</router-link>
    </div>
    <div class="top" :style="{'background-image':`url(${model.banner})`}">
      <div class="info text-white p-3 h-100 d-flex flex-column jc-end">
        ...
        <div class="d-flex jc-between pt-2">
          ...
          <span>生存</span>
          <span class="badge bg-dark">{{model.scores.survice}}</span>
        </div>
      ...
      <div class="px-3 bg-white">
        <div class="nav d-flex pt-3 pb-2 jc-around border-bottom">
          <div class="nav-item active">
            <div class="nva-link">英雄初始</div>
          </div>
          <div class="nav-item">
            <div class="nva-link">进阶攻略</div>
          </div>
        </div>
      </div>
      <swiper>
            ...
            <div class="p-3 bg-white border-bottom">
              ...
              <div class="skills bg-white mt-4">
                ...
                <div v-if="currentSkill">
                  ...
                  <p text-grey-1>小提示:{{currentSkill.tips}}</p>
                </div>
              </div>
...
<style lang="scss">
  ...
  .page-hero {
    ...
    .info {
      background: linear-gradient(rgba(0,0,0,0),rgba(0,0,0,1)); // 从上往下渐变黑
      .scores {
        .badge{
          margin:0 0.25rem;
